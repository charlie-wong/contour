...
{
    auto constexpr defaultColor = RGBColor{0x10, 0x20, 0x30};
...
{
    auto constexpr defaultColor = RGBColor{0, 0, 0};
...
{
    auto constexpr pinColors = std::array<RGBColor, 4> {
        RGBColor{255, 0, 0},
        RGBColor{0, 255, 0},
        RGBColor{0, 0, 255},
